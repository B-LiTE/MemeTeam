...
public class Item_Database : MonoBehaviour {
	...
	void Awake () 
    {
		...
		allItems.Add(new Weapon_Item(1,"Iron Sword","Weapon",1,10,2,3,1,0,Weapon_Item.weaponType.sword));
		allItems.Add(new Armor_Item(2,"Iron Shield","Armor",1,16,10));
		allItems.Add(new Weapon_Item(3, "Volcano Sword", "Weapon",1,20,3,3.2f,1,0,Weapon_Item.weaponType.sword));
		allItems.Add(new Potion_Item(4, "Potion", "Potion",20, 5, 25));
		allItems.Add(new Weapon_Item(5, "Rainbow Sword", "Weapon",1,50,16,3.5f,1,0,Weapon_Item.weaponType.sword));
		allItems.Add(new Weapon_Item(6, "Jagged Knife", "Weapon",1,30,6,3f,1,0,Weapon_Item.weaponType.sword));
		...
		allItems.Add(new Weapon_Item(12, "Mechanism Sword", "Weapon",1,40,7,3f,1,0,Weapon_Item.weaponType.sword));
		allItems.Add(new Potion_Item(13, "Alpha Potion", "Potion",20, 10, 50));
		allItems.Add(new Potion_Item(14, "Omega Potion", "Potion",20, 15, 75));
		allItems.Add(new Weapon_Item(15,"Crossbow","Weapon",1,25,4,18,1f,1,Weapon_Item.weaponType.bow));
		allItems.Add(new Weapon_Item(16,"Phoenix","Weapon",1,28,3,25,1f,1,Weapon_Item.weaponType.bow));
		allItems.Add(new Weapon_Item(17,"Wooden Bow","Weapon",1,10,2,20,1f,1,Weapon_Item.weaponType.bow));
		allItems.Add(new Weapon_Item(18,"Green Bow","Weapon",1,35,5,30,1f,1,Weapon_Item.weaponType.bow));
		allItems.Add(new Weapon_Item(19,"Mechanism Bow","Weapon",1,50,8,25,1f,1,Weapon_Item.weaponType.bow));
